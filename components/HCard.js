    ...
    <View style={historyStyle.subCardContainer}>
      <View style={{ width: '70%' }}>
        ...
        <View style={historyStyle.dateContainer}>
          ...
          <Text style={historyStyle.date}>{`Picked up on: ${pickup_date.toDateString()}`}</Text>
        </View>
        <View style={historyStyle.dateContainer}>
          <View
            style={{
          ...
          <Text style={historyStyle.date}>{`Return Date : ${return_date.toDateString()}`}</Text>
        </View>
        <View style={historyStyle.dateContainer}>
          <View
            style={{
          ...
          <Text style={historyStyle.date}>{`Returned on: ${actual_return.toDateString()}`}</Text>
        </View>
      </View>
